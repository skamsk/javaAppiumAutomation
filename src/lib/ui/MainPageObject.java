...
public class MainPageObject {
    ...
    public WebElement waitForElementPresent(By by, String error_message, long timeout_InSeconds)
    {
    ...
    public WebElement waitForElementAndClick(By by, String error_message, long timeout_InSeconds)
    {
